...
/* ----- Global Variables ---------------------------------------- */
	...
	function Game() {
		...
		this.map;
		this.pillCount;
        this.acertou = false;				// number of pills
		this.monsters;
		this.level = 1;
		...
		this.pauseResume = function () {
			if (!this.running) {
				...
				this.showMessage("Pause","Clique para Continuar");
				}
			};
...
function checkAppCache() {
	...
	$(document).ready(function() {
		...
		function renderContent()
		{
            ...
            context.arc(40, 40, 15, 0, Math.PI*2);
            context.fill(); // fill() is to fill in the circle, stroke() is for a empty circle.

            //vermelho
            context.beginPath();
            context.fillStyle = "Red";
            context.strokeStyle = "Red";
            context.arc(490, 40, 15, 0, Math.PI*2);
            context.fill(); // fill() is to fill in the circle, stroke() is for a empty circle.
            ...
            context.arc(40, 350, 15, 0, Math.PI*2);
            context.fill(); // fill() is to fill in the circle, stroke() is for a empty circle.
            ...
            context.arc(490, 350, 15, 0, Math.PI*2);
            context.fill(); // fill() is to fill in the circle, stroke() is for a empty circle.
